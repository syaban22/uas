...
<script src="<?= base_url('asset/'); ?>js/perusahaan_js/jquery.waypoints.min.js"></script>
<script src="<?= base_url('asset/'); ?>js/perusahaan_js/jquery.stellar.min.js"></script>
<script src="<?= base_url('asset/'); ?>js/perusahaan_js/owl.carousel.min.js"></script>
<script src="<?= base_url('asset/'); ?>js/perusahaan_js/aos.js"></script>
<script src="<?= base_url('asset/'); ?>js/perusahaan_js/jquery.animateNumber.min.js"></script>
<script src="<?= base_url('asset/'); ?>js/perusahaan_js/scrollax.min.js"></script>

<script src="<?= base_url('asset/'); ?>js/perusahaan_js/main.js"></script>
