...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-lg">
			...
			<a href="" class="btn btn-primary" data-toggle="modal" data-target="#perusahaanBaru">Tambah Perusahaan Baru</a>
				...
				<tbody>
					...
					<?php foreach ($perusahaan as $p) : ?>
						<tr>
							...
							<td><?= $p['perusahaan']; ?></td>
							<td>
								<a href="" class="badge badge-success" data-toggle="modal" data-target="#perusahaanEdit<?= $p['id'] ?>">Edit</a>
								<a href="<?= base_url('admin/deleteP/' . $p['id']) ?>" class="badge badge-danger">Delete</a>
							</td>
						</tr>
						<?php $no++; ?>
					<?php endforeach; ?>
